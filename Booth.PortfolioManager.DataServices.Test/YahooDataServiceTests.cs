...
namespace Booth.PortfolioManager.DataServices.Test
{
    ...
    public class YahooDataServiceTests
    {
        ...
        [Fact]
        public async Task GetHistoricalPriceDataMissingResultNode()
        {
            var mockRepository = new MockRepository(MockBehavior.Strict);
        ...
        [Fact]
        public async Task GetHistoricalPriceDataMissingTimeStampsNode()
        {
            var mockRepository = new MockRepository(MockBehavior.Strict);
        ...
        [Fact]
        public async Task GetHistoricalPriceDataMissingQuoteNode()
        {
            var mockRepository = new MockRepository(MockBehavior.Strict);
        ...
        [Fact]
        public async Task GetHistoricalPriceDataEncounterInvalidTimeStamp()
        {
            var mockRepository = new MockRepository(MockBehavior.Strict);
            ...
            requestMessage.Method.Should().Be(HttpMethod.Get);
            requestMessage.RequestUri.AbsoluteUri.Should().StartWith("https://query1.finance.yahoo.com/v8/finance/chart/BHP.AX?interval=1d&range=");
            result.Should().BeEquivalentTo(new StockPrice[] { new StockPrice("BHP", new Date(2024, 10, 14), 43.80m), new StockPrice("BHP", new Date(2024, 10, 15), 44.01m) });
        }

        [Fact]
        public async Task GetHistoricalPriceDataEncounterInvalidPrice()
        {
            var mockRepository = new MockRepository(MockBehavior.Strict);
            ...
            requestMessage.Method.Should().Be(HttpMethod.Get);
            requestMessage.RequestUri.AbsoluteUri.Should().StartWith("https://query1.finance.yahoo.com/v8/finance/chart/BHP.AX?interval=1d&range=");
            result.Should().BeEquivalentTo(new StockPrice[] { new StockPrice("BHP", new Date(2024, 10, 11), 43.43m), new StockPrice("BHP", new Date(2024, 10, 15), 44.01m) });
        }
